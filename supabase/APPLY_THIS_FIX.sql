-- =============================================
-- CRITICAL FIX: Apply User Isolation RLS Policies
-- =============================================
-- INSTRUCTIONS:
...
--
-- This fixes the theme generation failure and ensures proper data isolation.
-- =============================================
...
DROP POLICY IF EXISTS "Allow authenticated read surveys" ON surveys;
...
DROP POLICY IF EXISTS "Allow authenticated read themes" ON themes;
...
DROP POLICY IF EXISTS "Allow authenticated read narratives" ON narratives;
...
DROP POLICY IF EXISTS "Allow authenticated read indicators" ON indicators;
...
DROP POLICY IF EXISTS "Allow authenticated read heatmap" ON heatmap_data;
...
DROP POLICY IF EXISTS "Allow authenticated read responses" ON survey_responses;
DROP POLICY IF EXISTS "Allow authenticated users to manage responses" ON survey_responses;
...
DROP POLICY IF EXISTS "Allow authenticated read answers" ON response_answers;
DROP POLICY IF EXISTS "Allow authenticated users to manage answers" ON response_answers;
...
DROP POLICY IF EXISTS "Allow authenticated read questions" ON survey_questions;
DROP POLICY IF EXISTS "Allow authenticated users to manage questions" ON survey_questions;
...
-- =============================================
-- DEPARTMENTS TABLE - Shared across users
-- =============================================
...
-- =============================================
-- Verify the policies (optional - for debugging)
-- =============================================
SELECT
    tablename,
    policyname,
